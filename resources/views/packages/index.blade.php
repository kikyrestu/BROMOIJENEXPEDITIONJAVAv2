...
<x-app-layout :seo="$seo">
    ...
    <div class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden">
        <div class="absolute inset-0 bg-brand-dark">
            <img src="{{ asset('images/heroes/hero-1_optimized.webp') }}" alt="Mount Bromo landscape" class="w-full h-full object-cover opacity-40">
    ...
    <section class="py-16 md:py-24 bg-white relative">
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            ...
            {{-- Banner: Package Hero --}}
            <x-banner-spot location="package_hero" />
            ...
            @else
                <div class="text-center py-20 bg-slate-50 rounded-3xl border border-slate-100">
                    ...
                    <h3 class="text-lg font-bold text-slate-700">No packages found</h3>
                    <p class="text-slate-500">We are currently curating new experiences. Check back soon!</p>
                </div>
            @endif

            {{-- Banner: Package Footer --}}
            <x-banner-spot location="package_footer" />
