...
<section class="py-16 bg-white relative font-sans" id="packages" data-slider-id="{{ $sliderId }}"
    x-data="{
        ...
        isVisible(destName, catName) {
            if (this.activeCategory === 'all') return true;
            return destName === this.activeCategory || catName === this.activeCategory;
        }
    }">
            ...
            <div class="swiper-wrapper !items-stretch py-4 pb-12">
                @foreach($packages as $package)
                    <div class="swiper-slide !w-[280px] md:!w-[380px] !h-auto flex flex-col transition-all duration-300"
                        ...
                        {{-- Card Container --}}
                        <div class="bg-white rounded-2xl p-4 shadow-md border border-slate-100 hover:shadow-xl transition-all duration-300 h-full w-full flex flex-col group">
...
(function() {
    ...
    function initSectionSwiper() {
        ...
        // Store on section for Alpine access
