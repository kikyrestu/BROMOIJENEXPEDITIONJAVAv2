@props(['socials' => [], 'showBackToTop' => true])

{{-- Floating Social Bar (Always visible) + Back to Top (on scroll) --}}
<style>[x-cloak] { display: none !important; }</style>

<div class="fixed bottom-8 right-6 z-50 flex flex-col items-center gap-3">
    ...
    {{-- Back to Top Button - ONLY SHOWS ON SCROLL --}}
    @if($showBackToTop)
    <div x-data="{ showBtn: false }" 
         x-init="window.addEventListener('scroll', () => showBtn = window.scrollY > 300)"
         x-show="showBtn"
