            ...
            <div data-preview-type="{{ $type }}">
                ...
                @switch($type)
                    ...
                    @case('exclusive_destinations')
                        ...
                        {{-- Debug Log for Destinations --}}
                        <script>
                            console.group('[Debug] Exclusive Destinations Section');
                            console.log('Total Destinations:', {{ $destinations->count() }});
                            console.log('Destinations Data:', @json($destinations->map(fn($d) => ['id' => $d->id, 'name' => $d->name, 'thumbnail' => $d->thumbnail])));
                            console.groupEnd();
                        </script>
