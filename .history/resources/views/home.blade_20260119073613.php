                        ...
                        @php
                            ...
                            // Map Images
                             if (($data['source_type'] ?? '') === 'media_library' && !empty($data['media_id'])) {
                                 ...
                                 if($media) $aboutData['main_image'] = \Illuminate\Support\Facades\Storage::url($media->path);
                            ...
                            if (($data['secondary_source_type'] ?? '') === 'media_library' && !empty($data['secondary_media_id'])) {
                                 ...
                                 if($media) $aboutData['secondary_image'] = \Illuminate\Support\Facades\Storage::url($media->path);
