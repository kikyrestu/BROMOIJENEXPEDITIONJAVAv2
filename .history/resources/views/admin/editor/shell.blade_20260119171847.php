        ...
        function visualEditor() {
            return {
                ...
                updatePreview(index, field, value) {
                    // Update Local State
                    // This function is often just a hook, x-model does most heavy lifting usually.
                    // But if we need complex logic:
                    // this.page.content[index].data[field] = value;
                    
                    // Post Message to Iframe for instant preview if supported
                    // TODO: Implement field-specific live updates
                    
                    if (this.$refs.previewFrame && this.$refs.previewFrame.contentWindow) {
                        // For simple text updates, we might want to reload or send message
                        // Currently reloading easiest for complex blocks
                ...
                prepareData() {
                    this.page.content.forEach(block => {
                        ...
                        if (block.type === 'blog_news') {
                            if (typeof block.data.badge_text === 'undefined') block.data.badge_text = 'Blog & News';
                            if (typeof block.data.title_prefix === 'undefined') block.data.title_prefix = 'Explore Blogs';
                            if (typeof block.data.title_suffix === 'undefined') block.data.title_suffix = 'And News';
                        }
