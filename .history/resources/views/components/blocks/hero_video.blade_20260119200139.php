...
<script>
    console.group("🔍 Hero Video PHP Data Debug");
    console.log("Raw Data Received:", @json($data));
    console.log("Show Button Key Exists?", @json(array_key_exists('show_button', $data)));
    console.log("Show Button Computed Value:", @json($showButton));
    console.groupEnd();
</script>
            ...
            window.addEventListener('message', (e) => {
                if (e.data.type === 'UPDATE_BLOCK_FIELD' && e.data.index == this.$el.dataset.blockIndex) {
                     ...
                     if (e.data.field === 'show_button') {
                         ...
                         console.log('[Button Debug] Section: hero_video | Button (show_button) Visible:', this.showButton);
                     }
