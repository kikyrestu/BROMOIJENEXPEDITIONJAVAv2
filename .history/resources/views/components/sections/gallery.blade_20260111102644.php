    ...
    <div class="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div class="text-center max-w-3xl mx-auto mb-12">
            ...
            <h2 class="text-4xl md:text-5xl font-extrabold text-brand-dark tracking-tight leading-tight mb-4">
                Capture The <span class="text-brand-primary font-hand italic">Moments</span>
            </h2>
            <p class="text-slate-500 text-lg">
                Explore the beauty of East Java through our lens. From the sunrise of Bromo to the blue fire of Ijen.
            </p>
        </div>
