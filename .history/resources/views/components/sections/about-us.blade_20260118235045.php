...
@php
    ...
    // Images
    $mainImage = !empty($data['main_image']) ? \Illuminate\Support\Facades\Storage::url($data['main_image']) : 'https://placehold.co/600x800?text=Adventure';
    $secondaryImage = !empty($data['secondary_image']) ? \Illuminate\Support\Facades\Storage::url($data['secondary_image']) : 'https://placehold.co/500x500?text=Joy';
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div class="relative w-full max-w-sm mx-auto lg:max-w-none">
                ...
                <div class="absolute -bottom-6 -right-2 md:right-8 lg:right-16 w-[45%] aspect-square bg-white p-2 rounded-tl-[30px] rounded-br-[30px] shadow-lg z-20 hidden md:block border border-slate-100">
                     <img src="{{ $secondaryImage }}" class="w-full h-full object-cover rounded-tl-[24px] rounded-br-[24px]">
                </div>
            ...
            <div class="lg:pl-6 mt-8 lg:mt-0 text-center lg:text-left">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8 text-left">
                    ...
                    <div class="flex items-start gap-4 justify-center lg:justify-start">
                        ...
                        <div>
                            <h4 class="font-bold text-brand-dark text-xl mb-1">{{ $feature['title'] }}</h4>
