...
@php
    ...
    $mainImage = !empty($data['main_image']) ? $data['main_image'] : 'https://placehold.co/600x800?text=Adventure';
    $secondaryImage = !empty($data['secondary_image']) ? $data['secondary_image'] : 'https://placehold.co/500x500?text=Joy';
