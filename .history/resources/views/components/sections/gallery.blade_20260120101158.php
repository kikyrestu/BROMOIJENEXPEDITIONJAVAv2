...
<section class="py-16 md:py-24 bg-white relative font-sans overflow-hidden">
    ...
    <div class="container mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 auto-rows-[200px]"
             x-data="{ lightbox: false, lightboxSrc: '', lightboxAlt: '' }">
            ...
            @foreach($images as $img)
                ...
                <div class="{{ $sizeClass }} group relative rounded-3xl overflow-hidden cursor-pointer"
                     @click="lightboxSrc = '{{ $imgUrl }}'; lightboxAlt = '{{ addslashes($caption) }}'; lightbox = true">
            ...
            <div x-show="lightbox"
                 ...
                 style="display: none;">
                <button @click="lightbox = false" class="absolute top-4 right-4 text-white hover:text-brand-accent transition z-10">
                ...
                <p x-show="lightboxAlt" class="absolute bottom-4 left-1/2 -translate-x-1/2 text-white text-sm bg-black/50 px-4 py-2 rounded-full" x-text="lightboxAlt"></p>
            </div>
        </div>
