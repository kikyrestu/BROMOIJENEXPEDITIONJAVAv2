<x-app-layout :seo="$page->seo ?? null">
    ...
    {{-- Hero Section --}}
    <x-blocks.hero_video :data="[
        'heading' => $page->title ?? 'EXPLORE EAST JAVA',
        'subheading' => strip_tags($page->content ?? 'Experience the majestic sunrise of Bromo and the blue fire of Ijen Crater with our premium expedition service.'),
