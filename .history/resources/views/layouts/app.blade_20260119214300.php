        ...
        <div class="container mx-auto px-6 md:px-12 lg:px-20">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:block">
                    <a href="#book" class="px-6 py-2.5 rounded-full bg-brand-accent hover:bg-white hover:text-brand-accent text-white transition font-bold shadow-lg border-2 border-transparent hover:border-brand-accent">
                        Get in Touch
                    </a>
                </div>
            </div>
