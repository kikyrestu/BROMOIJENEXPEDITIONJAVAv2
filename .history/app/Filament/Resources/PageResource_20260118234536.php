            ...
            ->schema([
                ...
                Forms\Components\Builder::make('content')
                    ...
                    ->blocks([
                        ...
                        // 2. About Us Block (Static/Simple)
                        Forms\Components\Builder\Block::make('about_us')
                            ->label('About Us Section')
                            ->schema([
                                Forms\Components\Placeholder::make('info')
                                    ->content('This section is currently static in the template. Adding this block enables it.'),
                            ]),
                        ...
                        Forms\Components\Builder\Block::make('gallery')
                            ...
                            ->schema([
                                Forms\Components\Placeholder::make('info_gallery')
                                    ->content('Displays the static gallery grid.'),
                            ]),
