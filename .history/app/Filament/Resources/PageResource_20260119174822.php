                        ...
                        Forms\Components\Builder\Block::make('hero_video')
                            ->schema([
                                ...
                                Forms\Components\TextInput::make('video_url')
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('video_source') === 'url')
                                    ->helperText('Enter a direct video URL (mp4) or YouTube link.'),
                                
                                Forms\Components\FileUpload::make('video_file')
                                    ->disk('public')
                                    ->directory('hero-videos')
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('video_source') === 'upload'),
                                ...
                                Forms\Components\TextInput::make('button_text')
                                    ...
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('show_button')),
                        ...
                        Forms\Components\Builder\Block::make('blog_news')
                            ...
                            ->schema([
                                ...
                                Forms\Components\Placeholder::make('auto_fetch_help')
                                    ...
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('auto_fetch')),
                        ...
                        Forms\Components\Builder\Block::make('hotspots')
                            ...
                            ->schema([
                                ...
                                Forms\Components\FileUpload::make('image_file')
                                    ->image()
                                    ->directory('hotspots')
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('image_source') === 'upload'),
                                Forms\Components\TextInput::make('image_url')
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('image_source') === 'url'),
                                Forms\Components\Select::make('media_id')
                                    ...
                                    ->visible(fn (\Filament\Forms\Get $get) => $get('image_source') === 'media_library')
